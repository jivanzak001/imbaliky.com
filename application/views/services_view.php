...
<div id="main">
    ...
    <div class="breadcrumb-section">
        <div class="container">
            ...
            <div class="breadcrumb">
                ...
                <span class="current">Ծառայություններ</span>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <section id="primary" class="content-full-width">
            <?php foreach ($all_services as $items): ?>
                    ...
                    <article class="blog-entry">
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-thumb">
                                <a href="<?= base_url(); ?>services/service/<?= $items['id']; ?>">
                                    <img  src="<?= base_url(); ?>images/news/<?= $items['img_name']; ?> " alt="" title=""></a>
                            </div>
